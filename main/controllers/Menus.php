...
class Menus extends Main_Controller {
    ...
    public function getList($filter, $list_data = array(),$location_id = '') {
        ...
        $list_data['menus'] = $this->Menus_model->getList($filter,'',$location_id);

        $categories = $this->Categories_model->getCategories(NULL,'',$location_id);
        ...
        foreach (sort_array($categories) as $category) {
            ...
            $count_cat = $this->Menus_model->getChild($category['category_id']);
            // echo $count_cat;
            // exit;
            ...
            $list_data['categories'][$category['category_id']] = array(
                ...
                'is_child'          =>  $is_child,
                'name'	            =>	$category['name'],
                'name_ar'           =>  $category['name_ar']=='' ? $category['name'] : $category['name_ar'],
