...
class Reset extends Main_Controller {
	...
	private function _resetPassword() {															// method to validate password reset
		if ($this->validateForm() === TRUE) {
            ...
            if ($this->Customers_model->resetPassword($this->input->post('email'), $reset)) { // invoke reset password method in Customers model using customer id, email and security answer
	...
	private function validateForm() {
		$this->form_validation->set_rules('email', 'lang:label_email', 'xss_clean|trim|required|valid_email');	//validate form
