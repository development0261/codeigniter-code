...
$theme['title']         = 'RestaurantCart';
$theme['author']        = 'Uplogic';
$theme['version']       = '2.0';
...
$theme['head_tags'] = array(
	'doctype'   => 'html5',
	'favicon'   => theme_url('spotneat/images/favicon.png'),
	'meta'     	=> array(
		...
		array('property' => "og:url", 'content'=>""),
		array('property' => "og:site_name", 'content'=>""),
		array('property' => "og:description", 'content'=>""),
		array('name' => "twitter:title", 'content'=>""),
		array('name' => "twitter:image", 'content'=>""),
		array('name' => "twitter:url", 'content'=>""),
		array('name' => "twitter:card", 'content'=>""),

	),
	'style'    	=> array(	
		
		array(theme_url('spotneat/css/css.css'), 'google-css', '1'),
		array(theme_url('spotneat/css/all.css'), 'bootstrap-css', '2'),
		
		/* Animate.css */
		array(theme_url('spotneat/css/animate.css'),'animate-css', '3'),
		/* Icomoon Icon Fonts */
		array(theme_url('spotneat/css/icomoon.css'),'icomoon-css', '4'),
		/* Bootstrap */
		array(theme_url('spotneat/css/bootstrap.css'),'bootstrap-css', '5'),
		/* Superfish */
		array(theme_url('spotneat/css/superfish.css'),'superfish-css', '6'),
		/* Magnific Popup */
		array(theme_url('spotneat/css/magnific-popup.css'),'magnific-css', '7'),
		/* Date Picker */
		array(theme_url('spotneat/css/bootstrap-datepicker.min.css'),'datepicker-css', '8'),
		/* CS Select */
		array(theme_url('spotneat/css/cs-select.css'),'cs-select-css', '9'),
		array(theme_url('spotneat/css/cs-skin-border.css'),'cs-skin-css', '10'),
		array(theme_url('spotneat/css/font-awesome.min.css'), 'font-awesome-css', '11'),
		array(theme_url('spotneat/css/select2.css'), 'select2-css', '12'),
		array(theme_url('spotneat/css/select2-bootstrap.css'), 'select2-bootstrap-css', '13'),
		array(theme_url('spotneat/css/jquery.raty.css'), 'jquery-raty-css', '15'),
		array(theme_url('spotneat/css/fonts.css'), 'fonts-css', '16'),
		array(theme_url('spotneat/css/style.css'),'style-css', '17'),

	),
	'script'   	=> array(
		/*array(theme_url('spotneat/js/jquery-1.11.2.min.js'), 'jquery-js', '1'),
		array(theme_url('spotneat/js/bootstrap.min.js'), 'bootstrap-js', '10'),
		array(theme_url('spotneat/js/select2.js'), 'select-2-js', '12'),
		array(theme_url('spotneat/js/jquery.raty.js'), 'jquery-raty-js', '13'),
		array(theme_url('spotneat/js/common.js'), 'common-js', '100100100100100'),*/
		//array(theme_url('spotneat/js/jquery-1.11.3.min.js')),
		//array(theme_url('spotneat/js/jquery.mobile-1.4.5.min.js')),
		/* Modernizr JS */
		//array(theme_url('spotneat/js/modernizr-2.6.2.min.js')),
		/* [if lt IE 9]> */
		//array(theme_url('spotneat/js/respond.min.js')),
		/* <![endif] */
		array(theme_url('spotneat/js/jquery.min.js'), 'jquery-js', '1'),
	    /* jQuery Easing */
	    array(theme_url('spotneat/js/jquery.easing.1.3.js'), 'easing-js', '2'),
	    /* Bootstrap */
	    array(theme_url('spotneat/js/bootstrap.min.js'), 'bootstrap-js', '3'),
	    /* Waypoints */
	    array(theme_url('spotneat/js/jquery.waypoints.min.js'), 'waypoints-js', '4'),
	    array(theme_url('spotneat/js/sticky.js'), 'sticky-js', '7'),

	    /* Stellar */
	    array(theme_url('spotneat/js/jquery.stellar.min.js'), 'stellar-js', '10'),
	    /* Superfish */
	    array(theme_url('spotneat/js/hoverIntent.js'), 'hover-js', '13'),
	    array(theme_url('spotneat/js/superfish.js'), 'bootstrap-js', '16'),
	    /* Magnific Popup */
	    array(theme_url('spotneat/js/jquery.magnific-popup.min.js'), 'magnific-popup-js', '19'),
	    array(theme_url('spotneat/js/magnific-popup-options.js'), 'magnific-opt-js', '22'),
	    /* Date Picker */
	    array(theme_url('spotneat/js/bootstrap-datepicker.min.js'), 'datepicker-js', '25'),
	    /* CS Select */
	    array(theme_url('spotneat/js/classie.js'), 'classie-js', '28'),
	    array(theme_url('spotneat/js/selectFx.js'), 'selectFx-js', '31'),
	    
	    /* Main JS */
	    array(theme_url('spotneat/js/main.js'), 'main-js', '34'),

	    array(theme_url('spotneat/js/select2.js'), 'select-2-js', '35'),
		array(theme_url('spotneat/js/jquery.raty.js'), 'jquery-raty-js', '36'),
		array(theme_url('spotneat/js/common.js'), 'common-js', '38'),
		/* Modernizr JS */
		array(theme_url('spotneat/js/modernizr-2.6.2.min.js'), 'modernizr-2-js', '40'),
...
$theme['partial_area'] = array(
	array(
		'name'          => 'Content Top',
		'id'            => 'content_top',
		'open_tag'      => '<div id="{id}" class="partial partial-area {class} padd-none" >',
		'close_tag'     => '</div>',
	...
	array(
		'name'          => 'Content Bottom',
		'id'            => 'content_bottom',
		'open_tag'      => '<div class="clearfix"></div><div id="{id}" class="partial partial-area {class} padd-none">',
		'close_tag'     => '</div>',
		'module_html' 	=> '<div id="{id}" class="{class}">{module}</div>',
	),
	array(
...
/* Location: ./main/views/themes/spotneat/theme_config.php */