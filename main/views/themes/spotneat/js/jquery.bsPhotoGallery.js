(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function showModal(){
          ...
          var html = '';
          var img = '<img src="' + clicked.img + '" class="img-responsive"  style="width:auto !important;margin:auto !important;" />';

          html += img;
          html += '<span class="fa fa-times-circle-o clickable" data-dismiss="modal" style="position: absolute; right: 0px; top: 0px; font-size: 25px; color:#fff; text-shadow: 1px 1px 18px #000;"></span>';
