				...
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<ul id="nav-tabs" class="nav nav-tabs nav-tabs-line">
							...
							<!-- <li><a href="#orders" data-toggle="tab"><?php //echo lang('menu_recent_order'); ?></a></li> -->
							<!-- <li><a href="#reservations" data-toggle="tab"><?php echo lang('menu_recent_reservation'); ?></a></li> -->
							<!-- <li><a href="#inbox" data-toggle="tab"><?php echo sprintf(lang('text_inbox'), $inbox_total); ?></a></li> -->
						</ul>
					</div>

					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="tab-content tab-content-line wrap-top padd-none">
									...
									<table class="table table-none">
										<tbody>
											...
											<tr>
												...
												<td><a href="<?php echo $password_url; ?>"><b><?php echo lang('text_change_password'); ?></b></a></td>
											</tr>
											<tr>
											...
											<!-- <tr>
												...
												<td><?php echo lang_trans($customer_info['security_question'], $customer_info['security_question_ar']); ?></td>
											</tr>
											<tr>
											...
											<tr>
												<td><b><?php echo lang('label_reward_points'); ?></b></td>
												<td><?php echo $customer_info['reward_points']; ?></td>
											</tr>
										</tbody>
									</table>
								</div>
										...
										<table class="table table-none">
											...
											<tbody>
												<tr>
													...
													<td><button class="btn btn-primary btn-sm" href="<?php echo $checkout_url; ?>"><?php echo lang('text_checkout'); ?></button></td>
												</tr>
											</tbody>
										</table>
									</div>
										...
										<table class="table table-none">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo lang($reservation['status_name']); ?></td>
