							...
							<tbody>
								<?php if ($reviews) {?>
									...
									<tr>
										...
										<td><?php echo lang($review['sale_type']); ?></td>
										<td><?php echo lang_trans($review['location_name'], $review['location_name_ar']); ?></td>
										<td>
											<dl class="dl-horizontal dl-horizontal-rating">
												<dt><b><?php echo lang('quality'); ?>:</b></dt>
												...
												<dt><b><?php echo lang('service'); ?>:</b></dt>
