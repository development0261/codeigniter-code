...
?>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th width="50%" class="text-left"><?php echo lang('column_menu_name'); ?></th>
                                        <th width="20%" class="text-left"><?php echo lang('column_menu_price'); ?></th>
                                        <th width="20%" class="text-left"><?php echo lang('column_menu_subtotal'); ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
	...
	?>
                        ...
                        <div class="col-md-12">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="buttons pdf-generate">
