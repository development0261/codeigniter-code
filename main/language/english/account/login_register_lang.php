...
$lang['alert_invalid_login'] 	= '<p class="alert-danger">Invalid Email ID or Password!</p>';
$lang['alert_account_created'] 	= '<p class="alert-success">Account created successfully, login below!</p>';
$lang['alert_inactive_status'] 	= '<p class="alert-danger">Your account has been disabled.Kindly contact Restaurant Admin !</p>';
$lang['label_already_have_account'] =  'Already having an account? ';
