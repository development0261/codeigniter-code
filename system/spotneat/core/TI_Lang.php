 ...
 *
 * @category       Libraries
 * @package        SpotnEat\Core\TI_Lang.php
...
class TI_Lang extends MX_Lang {
	...
	public function defaultLang($langfile, $lang = '') {
		...
		$default_lang = APPDIR === ADMINDIR ? $_SESSION['admin_lang'] : $_SESSION['lang'];	
		}else{
		$default_lang = APPDIR === ADMINDIR ? $this->CI->config->item('admin_language_id') : $_SESSION['lang'];
		}
...
/* Location: ./system/spotneat/core/TI_Loader.php */