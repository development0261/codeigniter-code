...
class Migration_1_3_0 extends CI_Migration {
	...
	public function up() {
		...
		$this->db->query("INSERT INTO ".$this->db->dbprefix('settings')." (`setting_id`, `sort`, `item`, `value`, `serialized`) VALUES (10971, 'prefs', 'default_themes', 'a:2:{s:5:\"admin\";s:18:\"spotneat-blue/\";s:4:\"main\";s:20:\"spotneat-orange/\";}', 1);");
