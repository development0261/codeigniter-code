...
/**
 * SpotnEat Migration Class
 *
 * @category       Libraries
 * @package        SpotnEat\Libraries\TI_Migration.php
...
class TI_Migration extends CI_Migration {
	...
	/**
	 * Install SpotnEat core schema to the migration version set in config.
	 *
	...
	public function install() {
		...
		// Core Migrations - this is all that is needed for SpotnEat install.
...
/* Location: ./system/spotneat/core/TI_Migration.php */