 ...
 *
 * @category       Models
 * @package        SpotnEat\Models\Pages_model.php
...
class Pages_model extends TI_Model {
	...
	public function savePage($page_id, $save = array()) {
		...
		if ($save['content'] != '') {
		// 	echo '<pre>';
		// print_r($save['content']);
		// exit;
			$this->db->set('content', $save['content']);
		}

		// if (isset($save['content_arabic'])) {
		// 	$this->db->set('content_arabic', $save['content_arabic']);
		// }
...
/* Location: ./system/spotneat/models/pages_model.php */