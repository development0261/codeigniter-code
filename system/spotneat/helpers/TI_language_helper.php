 ...
 *
 * @category       Helpers
 * @package        SpotnEat\Helpers\TI_language_helper.php
...
{
	function lang_trans($trans,$trans_ar){
		$lang = $_SESSION['lang'];
		if($lang == 'arabic'){			
			return $trans_ar==""? $trans: $trans_ar ;
...
if ( ! function_exists('lang_trans_addr'))
{
	function lang_trans_addr($trans,$trans_ar){
		$lang = $_SESSION['lang'];
		if($lang == 'arabic'){			
			return $trans_ar==",,<br>,,<br>"? $trans: $trans_ar ;
...
/* Location: ./system/spotneat/helpers/ti_language_helper.php */