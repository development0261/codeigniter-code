...
class Cart_model extends TI_Model {
    ...
    public function getMenus() {
        $this->db->select('menus.menu_id, menu_name, menu_name_ar, menu_description,menu_description_ar, menu_price, menu_photo, stock_qty, subtract_stock,
                ...
                foreach ($query->result_array() as $row) {
                    if (!isset($results[$row['menu_option_id']])) {
                        $results[$row['menu_option_id']] = array(
                            ...
                            'option_name_ar'    => $row['option_name_arabic'],
