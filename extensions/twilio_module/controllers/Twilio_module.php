...
class Twilio_module extends Base_Controller {
   ...
   public function index() {
        if ( ! file_exists(EXTPATH .'twilio_module/views/twilio_module.php')) { 								//check if file exists in views folder
            show_404(); 																		// Whoops, show 404 error page!
        }
        
        $payment = $this->extension->getPayment('twilio_module');
        ...
        return $this->load->view('twilio_module/twilio_module', $data, TRUE);
    }
