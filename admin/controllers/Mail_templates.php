...
class Mail_templates extends Admin_Controller {
	...
	public function edit() {
		...
		$this->template->setButton($this->lang->line('button_icon_back'), array('class' => 'btn btn-default', 'href' => site_url('mail_templates'), 'title' => 'Back'));
		...
		$titles = array(
			...
			'password_reset_app'	=> $this->lang->line('text_password_reset_app'),
			...
			'guest_reservation'		=> $this->lang->line('text_guest_reservation'),
			'reservation_alert'		=> $this->lang->line('text_reservation_alert'),
			'reservation_location'	=> $this->lang->line('text_reservation_location'),
