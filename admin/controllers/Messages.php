...
class Messages extends Admin_Controller {
    ...
    public function view() {
        ...
        $this->template->setButton($this->lang->line('button_icon_back'), array('class' => 'btn btn-default', 'href' => site_url($previous_uri), 'title' => 'Back'));
    ...
    public function compose() {
        ...
        $this->template->setButton($this->lang->line('button_icon_back'), array('class' => 'btn btn-default', 'href' => site_url('messages'), 'title' => 'Back'));
