...
class Pages extends Admin_Controller {
	...
	public function edit() {
		...
		$this->template->setButton($this->lang->line('button_icon_back'), array('class' => 'btn btn-default', 'href' => site_url('pages'), 'title' => 'Back'));
		...
		if ($this->input->post() AND $page_id = $this->_savePage($this->input->post())) {
		...
		$data['content_arabic']		= html_entity_decode($page_info['content_arabic']);
