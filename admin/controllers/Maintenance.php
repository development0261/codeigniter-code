...
class Maintenance extends Admin_Controller {
    ...
    public function backup() {
        ...
        $this->template->setButton($this->lang->line('button_migrate'), array('class' => 'btn btn-success', 'onclick' => '$(\'#migrate-form\').submit();'));
        $this->template->setButton($this->lang->line('button_icon_back'), array('class' => 'btn btn-default', 'href' => site_url('maintenance'), 'title' => 'Back'));
        ...
        if ($this->input->post('file_name')) {
            ...
            $data['file_name'] = 'spotneat-' . $timestamp;
        }
