...
class Vendor extends Admin_Controller {
	...
	public function __construct() {
        ...
        $this->load->model('Vendor_model'); // load the menus model
	...
	public function index() {
		...
		if ($this->input->get('sort_by')) {
			...
			$filter['sort_by'] = $data['sort_by'] = 'staff_id';
		}
		...
		$this->template->setHeading(sprintf($this->lang->line('text_heading'), "Clients Categories"));
		...
		$data['sort_id'] 			= site_url('categories'.$url.'sort_by=staff_id&order_by='.$order_by);
		//print_r($filter);exit;
		$results = $this->Vendor_model->getList($filter);
		...
		foreach ($results as $result) {
			...
			$data['vendor'][] = array(
				...
				'status'		        => ($result['staff_status'] === '1') ? $this->lang->line('text_enabled') : $this->lang->line('text_disabled')
			);
		}
		...
		$config['base_url'] 		= site_url('vendor'.$url);
		$config['total_rows'] 		= $this->Vendor_model->getCount($filter);
		...
		$this->template->render('vendor', $data);
	}
	...
	public function menus() {
		...
		$this->template->setTitle($this->lang->line('text_title'));
		$this->template->setHeading(sprintf($this->lang->line('text_heading'), "Clients Menus"));
		...
		$config['base_url'] 		= site_url('vendor/menus'.$url);
		$config['total_rows'] 		= $this->Vendor_model->getCount($filter);
		$config['per_page'] 		= $filter['limit'];
		...
		$this->template->render('vendor_list_for_menu', $data);
	}
	...
	public function menu_options() {
		...
		$this->template->setTitle($this->lang->line('text_title'));
		$this->template->setHeading(sprintf($this->lang->line('text_heading'), "Clients Menu Options"));
		...
		$config['base_url'] 		= site_url('vendor/menu_options'.$url);
		$config['total_rows'] 		= $this->Vendor_model->getCount($filter);
		$config['per_page'] 		= $filter['limit'];
		...
		$this->template->render('vendor_list_for_menu_options', $data);
	}
	...
	public function reservations() {
		...
		$this->template->setTitle($this->lang->line('text_title'));
		$this->template->setHeading(sprintf($this->lang->line('text_heading'), "Clients Reservations"));
		...
		$config['base_url'] 		= site_url('vendor/reservations'.$url);
		$config['total_rows'] 		= $this->Vendor_model->getCount($filter);
		$config['per_page'] 		= $filter['limit'];
		...
		$this->template->render('vendor_list_for_reservations', $data);
	}
	...
	public function orders() {
		...
		$this->template->setTitle($this->lang->line('text_title'));
		$this->template->setHeading(sprintf($this->lang->line('text_heading'), "Clients Orders"));
		...
		$config['base_url'] 		= site_url('vendor/orders'.$url);
		$config['total_rows'] 		= $this->Vendor_model->getCount($filter);
		$config['per_page'] 		= $filter['limit'];
		...
		$this->template->render('vendor_list_for_orders', $data);
	}
		...
		$this->template->setTitle($this->lang->line('text_title'));
		$this->template->setHeading(sprintf($this->lang->line('text_heading'), "Clients Reviews"));
		...
		$config['base_url'] 		= site_url('vendor/reviews'.$url);
		$config['total_rows'] 		= $this->Vendor_model->getCount($filter);
		$config['per_page'] 		= $filter['limit'];
		...
		$this->template->render('vendor_list_for_reviews', $data);
	}
	...
	public function tables() {
		...
		$this->template->setTitle($this->lang->line('text_title'));
		$this->template->setHeading(sprintf($this->lang->line('text_heading'), "Tables"));

		$order_by = (isset($filter['order_by']) AND $filter['order_by'] == 'ASC') ? 'DESC' : 'ASC';
		$data['sort_name'] 			= site_url('tables'.$url.'sort_by=name&order_by='.$order_by);
		$data['sort_priority'] 		= site_url('tables'.$url.'sort_by=priority&order_by='.$order_by);
		$data['sort_id'] 			= site_url('tables'.$url.'sort_by=staff_id&order_by='.$order_by);
		//print_r($filter);exit;
		$results = $this->Vendor_model->getList($filter);
		...
		$this->template->render('vendor_list_for_tables', $data);
	}
	...
	public function edit() {
		...
		$this->template->setButton($this->lang->line('button_icon_back'), array('class' => 'btn btn-default', 'href' => site_url('categories'), 'title' => 'Back'));
		...
		$data['added_by'] 			= $category_info['added_by'];
