...
<div id="footer" class="<?php echo ($this->user->islogged()) ? '' : 'wrap-none'; ?>">
	<div class="row navbar-footer">
		<div class="col-sm-12 text-version">
			<p class="col-xs-9 wrap-none"><?php echo lang('spotneat_copyright'); ?></p>
			<p class="col-xs-3 text-right wrap-none">Version 1.0
			<?php //echo sprintf(lang('spotneat_version'), config_item('ti_version')); ?></p>
		</div>
	</div>
</div>
</div>
