	...
	<div class="col-md-12">
		<div class="row wrap-vertical">
			<ul id="nav-tabs" class="nav nav-tabs">
				...
				<!-- <li><a href="#content-arabic" data-toggle="tab"><?php echo lang('text_tab_content_arabic'); ?></a></li> -->
			</ul>
		</div>
		...
		<form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo $_action; ?>">
			<div class="tab-content">
				...
				<div id="content-arabic" class="tab-pane row">
					<div class="col-sm-12">
						<textarea name="content_arabic" id="input-wysiwyg-arabic" class="form-control" style="height:400px;width:100%;"><?php echo set_value('content', $content_arabic); ?></textarea>
						<?php echo form_error('content_arabic', '<span class="text-danger">', '</span>'); ?>
					</div>
				</div>
			</div>
		</form>
...
<script type="text/javascript">
	...
	$('#input-wysiwyg-arabic').summernote({
		height: 300,
	});
</script>
<?php echo get_footer(); ?>