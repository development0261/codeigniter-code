				...
				<table class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo lang('view_categories'); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><a href="categories?id=<?php echo $category['staff_id']; ?>" class="btn btn-info" title="View Categories"><i class="fa fa-eye"></i></a></td>
						</tr>
