	...
	<div class="col-md-12">
		<div class="panel panel-default panel-table">
			<div class="panel-heading">
				...
				<span style="float:right;" ><a href="<?php echo site_url().'orders?show=all&id=&filter_search=&filter_location=&filter_status=all&filter_payment=&filter_date' ; ?>">Show all orders</a> </span>	
				...
				<table class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo lang('view_orders'); ?></th>
					...
					<tbody>
						...
						<tr>
							<td><?php echo $category['location_name']; ?></td>
							<td><?php echo $category['staff_name']; ?></td>
                            <td><?php echo $category['staff_email']; ?></td>
							<td class="text-center"><?php echo $category['status']; ?></td>
							<td class="text-center"><a href="../orders?id=<?php echo $category['staff_id']; ?>&filter_search=&filter_status=all&filter_payment=&filter_date=" class="btn btn-info" title="View Orders"><i class="fa fa-eye"></i></a></td>
						</tr>
