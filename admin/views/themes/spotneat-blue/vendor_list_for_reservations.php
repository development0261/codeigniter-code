	...
	<div class="col-md-12">
		<div class="panel panel-default panel-table">
			<div class="panel-heading">
				...
				<span style="float:right;" ><a href="<?php echo site_url().'reservations?show=all' ; ?>">Show all reservations</a> </span>	
				...
				<table class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo lang('view_reservations'); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><a href="../reservations?id=<?php echo $category['staff_id']; ?>" class="btn btn-info" title="View Reservations"><i class="fa fa-eye"></i></a></td>
						</tr>
