		...
		<form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo $_action; ?>">
			<div class="tab-content">
				<div id="general" class="tab-pane row wrap-all active">
					...
					<div class="form-group">
						<label for="input-symbol" class="col-sm-3 control-label"><?php echo lang('label_symbol'); ?><span style="color:red">*</span></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="input-currency-rate" class="col-sm-3 control-label"><?php echo lang('label_rate'); ?><span style="color:red">*</span></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="input-thousand-sign" class="col-sm-3 control-label"><?php echo lang('label_thousand_sign'); ?><span style="color:red">*</span></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="input-decimal-sign" class="col-sm-3 control-label"><?php echo lang('label_decimal_sign'); ?><span style="color:red">*</span></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="input-decimal-position" class="col-sm-3 control-label"><?php echo lang('label_decimal_position'); ?><span style="color:red">*</span></label>
						<div class="col-sm-5">
