		...
		<form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo $_action; ?>">
			<div class="tab-content">
				<div id="general" class="tab-pane row wrap-all active">
					...
					<div class="form-group">
						<label for="input-iso-code-2" class="col-sm-3 control-label"><?php echo lang('label_iso_code2'); ?><span style="color:red">*</span>
					...
					<div class="form-group">
						<label for="input-iso-code-3" class="col-sm-3 control-label"><?php echo lang('label_iso_code3'); ?><span style="color:red">*</span></label>
						<div class="col-sm-5">
