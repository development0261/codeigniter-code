				...
				<table class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th><a class="sort" href="<?php echo $sort_name; ?>">Location<i class="fa fa-sort-<?php echo ($sort_by == 'location') ? $order_by_active : $order_by; ?>"></i></a></th>
							...
							<th><a class="sort" href="<?php echo $sort_type; ?>"><?php echo lang('column_type'); ?><i class="fa fa-sort-<?php echo ($sort_by == 'staff_name') ? $order_by_active : $order_by; ?>"></i></a></th>
							<th><a class="sort" href="<?php echo $sort_type; ?>">Access Type<i class="fa fa-sort-<?php echo ($sort_by == 'staff_name') ? $order_by_active : $order_by; ?>"></i></a></th>
							...
							<th><a class="sort" href="<?php echo $sort_validity; ?>">Start Date<i class="fa fa-sort-<?php echo ($sort_by == 'period_start_date') ? $order_by_active : $order_by; ?>"></i></a></th>
							<th><a class="sort" href="<?php echo $sort_validity; ?>">End Date<i class="fa fa-sort-<?php echo ($sort_by == 'period_end_date') ? $order_by_active : $order_by; ?>"></i></a></th>
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo !empty($locations) ? $locations[$coupon['location_id']]:''; ?></td>
							<td><?php echo $coupon['code']; ?></td>
							<td>
								<?php echo $coupon['type']; ?>
								<?php if($coupon['type_value'] == 'FD') { ?>
									<br/>
									<span><?php echo ($coupon['is_fd_type_percent'] == 1 ? '[Type: Percentage]':'[Type: Fixed]'); ?><span>
								<?php } ?>	
							</td>
							<td><?php echo $coupon['is_public_access'] == 1 ? 'Public':'<span style="color:#FF0000;">Private</span>'; ?></td>
							<td><?php echo number_format((float)$coupon['discount'],2,'.',''); ?></td>
							<td><?php echo $coupon['period_start_date']; ?></td>
							<td><?php echo $coupon['period_end_date']; ?></td>
