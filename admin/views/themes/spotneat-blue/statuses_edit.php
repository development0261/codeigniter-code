			...
			<div class="tab-content">
				<div id="general" class="tab-pane row wrap-all active">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="status_code" id="input-code" class="form-control" value="<?php echo set_value('status_code', $status_code); ?>" id="code" />
							<?php echo form_error('status_code', '<span class="text-danger">', '</span>'); ?>
						</div>
					</div>
					<div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="input-color" class="col-sm-3 control-label"><?php echo lang('label_color'); ?><span style="color:red">*</span></label>
                        <div class="col-sm-5">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label"><?php echo lang('label_status'); ?>
						</label>
						<div class="col-sm-5">
							<div class="btn-group btn-group-switch" data-toggle="buttons">
								<?php if ($status == '1') { ?>
