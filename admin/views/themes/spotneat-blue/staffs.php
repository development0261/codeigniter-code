					...
					<table border="0" class="table table-striped table-border">
						<thead>
							<tr>
								...
								<th><a class="sort" href="<?php echo $sort_location; ?>"><?php echo lang('column_restaurant'); ?><i class="fa fa-sort-<?php echo ($sort_by == 'location_name') ? $order_by_active : $order_by; ?>"></i></a></th>
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $staff['staff_telephone']; ?></td>
								<td><?php echo $staff['staff_group_name']; ?></td>
								<td><?php 
									// echo $staff['staff_group_name'] != 'Clients'?$staff['location_name']:$staff['restaurant_by'];
									echo $staff['restaurant_by'] == null?$staff['location_name']:$staff['restaurant_by'];
								?></td>
