	...
	<div class="col-md-12">
		<div class="row wrap-vertical">
			<ul id="nav-tabs" class="nav nav-tabs">
				...
				<li><a href="#restaurant" data-toggle="tab"><?php echo lang('text_tab_store'); ?></a></li>
				<li><a href="#option" data-toggle="tab"><?php echo lang('text_tab_options'); ?></a></li>
				<li class="hide-data"><a href="#order" data-toggle="tab"><?php echo lang('text_tab_order'); ?></a></li>
				<li class="hide-data"><a href="#reward" data-toggle="tab"><?php echo lang('text_tab_reward'); ?></a></li>
				<li class="hide-data"><a href="#reservation" data-toggle="tab"><?php echo lang('text_tab_reservation'); ?></a></li>
				<li class="hide-data"><a href="#image-manager" data-toggle="tab"><?php echo lang('text_tab_media_manager'); ?></a></li>
		...
		<form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo current_url(); ?>" enctype="multipart/form-data" />
			<div class="tab-content">
				<div id="general" class="tab-pane row wrap-all active">
					...
					<div class="form-group">
						<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_eat_right_pdf'); ?></label>
						<div class="col-sm-5">
							<div class="thumbnail imagebox" id="selectImage">
								<div class="caption">
									<span class="name text-center"><a href="<?php echo base_url().'/views/uploads/trainers/eat_right_pdf/'.$EAT_RIGHT_PDF; ?>" target="_blank">View PDF<a></span>
									<input type="file" name="eat_right_pdf" value="" id="eat_right_pdf" />			<input type="hidden" name="eat_right_pdf_old_value" id="eat_right_pdf_old_value" value="<?php echo $EAT_RIGHT_PDF; ?>" />			
								</div>
							</div>
							<?php echo form_error('site_logo', '<span class="text-danger">', '</span>'); ?>
						</div>
				...
				<div id="option" class="tab-pane row wrap-all">
					<!-- <h4 class="tab-pane-title"><?php echo lang('label_customer_mobile'); ?></h4>
					<div class="form-group ">
						<label for="input-customer-group" class="col-sm-3 control-label"><?php echo lang('label_customer_mobile'); ?></label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="digits_mobile" value="<?php echo set_value('digits_mobile', config_item('digits_mobile')); ?>">
					...
					<h4 class="tab-pane-title hide-data"><?php echo lang('text_tab_title_account'); ?></h4>
					<div class="form-group hide-data">
					...
					<h4 class="tab-pane-title hide-data"><?php echo lang('text_tab_title_terms'); ?></h4>
					<div class="form-group hide-data">
				...
				<div id="reward" class="tab-pane row wrap-all">
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="reward_value" id="input-max-size" class="form-control" value="<?php echo set_value('reward_value', config_item('reward_value')); ?>" size="5" />
							<?php echo form_error('reward_value', '<span class="text-danger">', '</span>'); ?>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="point_value" id="input-max-size" class="form-control" value="<?php echo set_value('point_value', config_item('point_value')); ?>" size="5" />
				...
				<div id="system" class="tab-pane row wrap-all">
					...
					<h4 class="tab-pane-title hide-data"><?php echo lang('text_tab_title_permalink'); ?></h4>
					<div class="form-group hide-data">
					...
					<h4 class="tab-pane-title hide-data"><?php echo lang('text_tab_title_customer_online'); ?></h4>
					<div class="form-group hide-data">
					...
					<h4 class="tab-pane-title hide-data"><?php echo lang('text_tab_title_caching'); ?></h4>
					<div class="form-group hide-data">
