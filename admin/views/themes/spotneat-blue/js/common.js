$(function() {
    ...
    var str4 = arr[arr.length - 2];
    var str5 = arr[arr.length - 1];

    if(str5 == 'vendor'){        
         $(".categories").addClass("active");
         $(".categories").parent().parent().addClass("in");
    }

    if(str4 == 'vendor' && str5 == 'orders'){        
         $(".orders").addClass("active");
         $(".orders").parent().parent().addClass("in");
    }
    if(str4 == 'vendor' && str5 == 'reservations'){        
         $(".reservations").addClass("active");
         $(".reservations").parent().parent().addClass("in");
    }

    if(str4 == 'vendor' && str5 == 'menus'){        
         $(".menus").addClass("active");
         $(".menus").parent().parent().addClass("in");
    }

    if(str4 == 'vendor' && str5 == 'reviews'){        
         $(".reviews").addClass("active");
         $(".reviews").parent().parent().addClass("in");
    }

    if(str4 == 'vendor' && str5 == 'menu_options'){        
         $(".menu_options").addClass("active");
         $(".menu_options").parent().parent().addClass("in");
    }
    ...
    if(str5 == 'payments'){        
         ...
         $(".payments").parent().parent().addClass("in");
    }

    if(str5 == 'payments_report'){        
         $(".payments_report").addClass("active");
         $(".payments_report").parent().parent().addClass("in");
    }
