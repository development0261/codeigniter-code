				...
				<table class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo lang('view_menus'); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><a href="../menu_options?id=<?php echo $category['staff_id']; ?>" class="btn btn-info" title="View Menu Options"><i class="fa fa-eye"></i></a></td>
						</tr>
