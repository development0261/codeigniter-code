        ...
        <form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo $_action; ?>">
            <div class="tab-content">
                <div id="general" class="tab-pane row wrap-all <?php echo (!empty($lang_files)) ? '' : 'active'?>">
                    ...
                    <div class="form-group">
                        <label for="input-code" class="col-sm-3 control-label"><?php echo lang('label_code'); ?><span style="color:red">*</span>
                    ...
                    <div class="form-group">
                        <label for="input-idiom" class="col-sm-3 control-label"><?php echo lang('label_idiom'); ?><span style="color:red">*</span>
