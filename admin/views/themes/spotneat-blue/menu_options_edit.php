	...
	<div class="col-md-12">
		<div class="row wrap-vertical">
			<ul id="nav-tabs" class="nav nav-tabs">
				...
				<li><a href="#values" data-toggle="tab"><?php echo lang('text_tab_sub_options'); ?></a></li>
			</ul>
		</div>
			...
			<div class="tab-content">
				<div id="general" class="tab-pane row wrap-all active">
					<div class="form-group">
						<label for="input-name" class="col-sm-3 control-label"><?php echo lang('label_option_name'); ?><span style="color:red">*</span> </label>
						<div class="col-sm-5">
							...
							<table class="table table-striped table-border table-sortable">
								<thead>
									<tr>
										...
										<th class="action action-one"></th>
										<th><?php echo lang('label_sub_option_name'); ?></th>
