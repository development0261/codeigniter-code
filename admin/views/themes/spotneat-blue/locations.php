				...
				<table border="0" class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th><a class="sort" href="<?php echo $sort_name; ?>"><?php echo lang('column_vendor'); ?><i class="fa fa-sort-<?php echo ($sort_by == 'location_name') ? $order_by_active : $order_by; ?>"></i></a></th>
						...
						<tr>
							<td class="action action-three"><input type="checkbox" value="<?php echo $location['location_id']; ?>" name="delete[]" />&nbsp;&nbsp;&nbsp;
								...
								<?php if ($location['default'] === '1') { ?>
									<a class="btn btn-edit" disabled="disabled" title="Default"><i class="fa fa-star"></i></a>
								<?php } else {?>
									<a class="btn btn-edit" title="Set Default" href="<?php echo $location['default']; ?>"><i class="fa fa-star-o"></i></a>
								<?php } ?>
							</td>
							...
							<td><?php echo $location['staff_name'] ? ucfirst($location['staff_name']) : '----' ; ?></td>
