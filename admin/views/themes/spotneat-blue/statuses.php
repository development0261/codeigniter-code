                    ...
                    <table class="table table-striped table-border">
                        <thead>
                            <tr>
                                ...
                                <th><a class="sort" href="<?php echo $sort_code; ?>"><?php echo lang('column_code'); ?><i class="fa fa-sort-<?php echo ($sort_by == 'status_code') ? $order_by_active : $order_by; ?>"></i></a></th>
                                ...
                                <th><a class="sort" href="<?php echo $sort_status; ?>"><?php echo lang('status'); ?><i class="fa fa-sort-<?php echo ($sort_by == 'status') ? $order_by_active : $order_by; ?>"></i></a></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $status['status_code']; ?></td>
                                <td><?php echo $status['status_comment']; ?></td>
                                <td><?php echo $status['status_for']; ?></td>
                                <td><?php echo $status['status'] == 1 ? 'Enabled' : 'Disabled'; ?></td>
