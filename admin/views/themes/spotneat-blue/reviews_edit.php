		...
		<form role="form" id="edit-form" class="form-horizontal" accept-charset="utf-8" method="POST" action="<?php echo $_action; ?>">
			<div class="tab-content">
				<div id="general" class="tab-pane row wrap-all active">
					...
					<div class="form-group">
						<label for="input-order" class="col-sm-3 control-label"><?php echo lang('label_sale_id'); ?><span style="color: red">*</span></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="input-author" class="col-sm-3 control-label"><?php echo lang('label_author'); ?><span style="color: red">*</span></label>
						<div class="col-sm-5">
					...
					<div class="form-group">
						<label for="input-rating" class="col-sm-3 control-label"><?php echo lang('label_rating'); ?><span style="color: red">*</span></label>
						<div class="col-sm-5">
