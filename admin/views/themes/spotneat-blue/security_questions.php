					...
					<table class="table table-striped table-border table-sortable">
						<thead>
							<tr>
								...
								<th class="id"><?php echo lang('column_language'); ?></th>
							</tr>
						</thead>
						<tbody>
							<?php $table_row = 0; ?>
							...
							<tr id="table-row<?php echo $table_row; ?>">
								...
								<td class="id"><?php echo lang('text_english'); ?><div style="margin-top:20px;"></div><?php echo lang('text_arabic'); ?></td>
							</tr>
...
function addQuestion() {
	...
	html += '		<input type="text" name="questions[' + table_row + '][text]" class="form-control" value="" /><div style="margin-top:10px;"></div><input type="text" name="questions[' + table_row + '][text_ar]" class="form-control" value="" /></td>';
	html += '	<td>-</td>';
	html += '</tr>';
