				...
				<table class="table table-striped table-border">
					<thead>
						<tr>
							...
							<th class="text-center"><?php echo lang('view_reviews'); ?></th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center"><a href="../reviews?id=<?php echo $category['staff_id']; ?>" class="btn btn-info" title="View Reviews"><i class="fa fa-eye"></i></a></td>
						</tr>
