...
<head>
	...
	<link type="image/ico" rel="shortcut icon" href="<?php echo base_url('views/assets/favicon.png'); ?>">
			...
			<div class="col-md-7 center-block">
				<div class="row page-header">
					<div class="col-xs-12 col-md-4 navbar-right">
						<img src="<?php echo base_url('views/assets/spotneat-logo.png'); ?>" alt="SpotnEat Logo">
					</div>
